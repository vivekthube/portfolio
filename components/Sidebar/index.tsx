      ...
      >
        <MotionStack variants={stagger} spacing={6} w="100">
          ...
          <MotionText
            ...
            variants={fadeInUp}
          >
            Or you could call me VT. That works too . . .
          </MotionText>
          ...
          >
            ...
            <br />I am software engineer that specializes at full stack projects, front
            end integration, recently found myself studying UX/UI too.
          </MotionText>
          <MotionButton
            size="lg"
            variant="outline"
            ...
            as={'a'}
            href="mailto:vivek10340@gmail.com"
            target="_blank"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
